...
extension FixturesRepository on LeagueRepository {
  ...
  Future<List<FixtureModel>> generateFixtures(int leagueId) async {
    final String path = '${AppConstants.pathLubowaLeagues}/$leagueId/fixtures/generate';
    final Response<List<dynamic>> response = await _dio.post<List<dynamic>>(path);
    final List<dynamic>? list = response.data;
    if (list == null) return <FixtureModel>[];
    return list.map((dynamic e) => FixtureModel.fromJson(e as Map<String, dynamic>)).toList();
  }
  ...
  Future<GoalLogEntry> recordGoals(int fixtureId, {required int playerId, required int goals}) async {
    ...
    final Map<String, dynamic>? goalJson = data['goal'] as Map<String, dynamic>?;
    if (goalJson == null) {
  ...
  Future<List<GoalLogEntry>> getFixtureGoals(int fixtureId, {bool forceRefresh = false}) async {
    ...
    return list.map((dynamic e) => GoalLogEntry.fromJson(e as Map<String, dynamic>)).toList();
  }
